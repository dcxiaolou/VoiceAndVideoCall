...
import com.android.dcxiaolou.voiceandvideocall.GroupVoiceCall.openacall.model.AGEventHandler;
...
public class VoiceChatActivity extends VoiceBaseActivity implements AGEventHandler {
    ...
    protected void initUIandEvent() {
        event().addEventHandler((AGEventHandler) this);
    ...
    protected void deInitUIandEvent() {
        ...
        doLeaveChannel();
        event().removeEventHandler((AGEventHandler) this);
    }
