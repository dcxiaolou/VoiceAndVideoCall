package com.android.dcxiaolou.voiceandvideocall.GroupVideoCall.openvcall.model;
...
public class VideoWorkerThread extends Thread {
    ...
    private static final class WorkerThreadHandler extends Handler {
        ...
        WorkerThreadHandler(VideoWorkerThread thread) {
            this.mVideoWorkerThread = thread;
        }
        ...
        public void handleMessage(Message msg) {
            ...
            switch (msg.what) {
                ...
                case ACTION_WORKER_JOIN_CHANNEL:
                    ...
                    mVideoWorkerThread.joinChannel(data[0], msg.arg1);
                    break;
                case ACTION_WORKER_LEAVE_CHANNEL:
                    String channel = (String) msg.obj;
                    mVideoWorkerThread.leaveChannel(channel);
                    break;
                case ACTION_WORKER_CONFIG_ENGINE:
                    Object[] configData = (Object[]) msg.obj;
                    mVideoWorkerThread.configEngine((VideoEncoderConfiguration.VideoDimensions) configData[0], (String) configData[1], (String) configData[2]);
                    break;
                case ACTION_WORKER_PREVIEW:
                    Object[] previewData = (Object[]) msg.obj;
                    mVideoWorkerThread.preview((boolean) previewData[0], (SurfaceView) previewData[1], (int) previewData[2]);
                    break;
            }
        }
    }
