package com.android.dcxiaolou.voiceandvideocall.GroupVoiceCall.openacall.ui;
...
import com.android.dcxiaolou.voiceandvideocall.GroupVoiceCall.openacall.model.EngineConfig;
import com.android.dcxiaolou.voiceandvideocall.GroupVoiceCall.openacall.model.MyEngineEventHandler;
...
public abstract class VoiceBaseActivity extends AppCompatActivity {
    ...
    public boolean checkSelfPermission(String permission, int requestCode) {
        ...
        if (Manifest.permission.RECORD_AUDIO.equals(permission)) {
            ((AGApplication) getApplication()).initWorkerThread(1);
        }
        return true;
    }

    protected RtcEngine rtcEngine() {
        return ((AGApplication) getApplication()).getVoiceWorkerThread().getRtcEngine();
    }

    protected final VoiceWorkerThread worker() {
        return ((AGApplication) getApplication()).getVoiceWorkerThread();
    }

    protected final EngineConfig config() {
        return ((AGApplication) getApplication()).getVoiceWorkerThread().getEngineConfig();
    }

    protected final MyEngineEventHandler event() {
        return ((AGApplication) getApplication()).getVoiceWorkerThread().eventHandler();
    }
    ...
    protected VoiceCurrentUserSettings vSettings() {
